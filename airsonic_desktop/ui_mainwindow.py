...
class Ui_AirsonicDesktop(object):
	def setupUi(self, AirsonicDesktop):
		...
		self.playPause.setMinimumSize(QtCore.QSize(25, 25))
		self.playPause.setAutoFillBackground(False)
		self.playPause.setStyleSheet("margin:0;padding:0;border:none;")
		...
		self.nextTrack.setMinimumSize(QtCore.QSize(25, 25))
	...
	def retranslateUi(self, AirsonicDesktop):
		...
		self.trackArtistName.setText(_translate("AirsonicDesktop", "TextLabel"))
