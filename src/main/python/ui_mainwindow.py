...
class Ui_vapoursonic(object):
	...
	def retranslateUi(self, vapoursonic):
		...
		self.selectedAlbumTrackCountIcon.setToolTip(
			_translate("vapoursonic", "The total number of songs in this album."))
		self.selectedAlbumTrackCountIcon.setText(_translate("vapoursonic", "CounIcon"))
		self.selectedAlbumTrackCount.setToolTip(_translate("vapoursonic", "The total number of songs in this album."))
		self.selectedAlbumTrackCount.setText(_translate("vapoursonic", "Count"))
		self.selectedAlbumTotalLengthIcon.setToolTip(_translate("vapoursonic", "The total length of this album."))
		self.selectedAlbumTotalLengthIcon.setText(_translate("vapoursonic", "LengthIcon"))
		self.selectedAlbumTotalLength.setToolTip(_translate("vapoursonic", "The total length of this album."))
		self.selectedAlbumTotalLength.setText(_translate("vapoursonic", "Length"))
		self.selectedAlbumReleaseYearIcon.setToolTip(_translate("vapoursonic", "The year this album was released."))
		self.selectedAlbumReleaseYearIcon.setText(_translate("vapoursonic", "YearIcon"))
		self.selectedAlbumReleaseYear.setToolTip(_translate("vapoursonic", "The year this album was released."))
		self.selectedAlbumReleaseYear.setText(_translate("vapoursonic", "Year"))
		self.toggleFollowPlayedTrackButton.setToolTip(
			_translate("vapoursonic", "Toggle whether the play queue selects the\n"
