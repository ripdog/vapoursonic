...
class Ui_vapoursonic(object):
    def setupUi(self, vapoursonic):
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.SpanningRole, self.connectButton)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.autoConnectCheckBox)
